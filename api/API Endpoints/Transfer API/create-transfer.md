...
|:---------|:---------|
| amount <br></br> <span style={{color: "red"}}>`Integer`</span> | Amount should be in the subunit of our supported currency i.e  NGN or GHS. |
| currency <br></br> <span style={{color: "red"}}>`String`</span> | Select the currency for the payment charge. This is in our supported currency which is currently only NGN and GHS. |
...
=======
    "status": "SUCCESSFUL"
>>>>>>> 23d2a39 (removed metadata from request and response)
}
```
