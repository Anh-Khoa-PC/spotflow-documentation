...
<span style={{color: "orange"}}>`POST`</span> https://dev-api.spotflow.co/api/v1/plans/:plan-id/cancel
...
This is the unique <span style={{color: "red"}}>`ID`</span> of the subscription plan you want to cancel.
